...
namespace LOBCore.Controllers
{
    ...
    [ApiController]
    public class LoginShortController : ControllerBase
    {
        ...
        public LoginShortController(IConfiguration configuration, LOBDatabaseContext context)
        {
        ...
        public string GenerateToken(LobUser fooUser)
        {
            ...
            (
                ...
                claims: claims,
                expires: DateTime.Now.AddSeconds(-1*(4*60+50)),
